...
const ASSETS = [
  ...
  { 
    ...
    icon: "₿",
    stats: "M1/M5 | Scalping Institucional",
  ...
  { 
    ...
    icon: "🇯🇵",
    stats: "M1/M5 | Volatilidad Asiática",
    ...
    <div className="min-h-screen bg-bg-dark pt-20 md:pt-24 pb-16 relative overflow-hidden">
      ...
      <section className="py-32 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-4xl font-black text-white mb-6 italic uppercase tracking-wider leading-relaxed">
