...
export default function ResultadosPage() {
    return (
        <div className="min-h-screen pt-20 md:pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-success/30 bg-success/10 text-success text-[10px] font-black uppercase tracking-widest mb-4">
                    <span className="w-2 h-2 rounded-full bg-success animate-pulse"></span>
                    Muro de Beneficios
                </div>

                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white uppercase italic tracking-tighter mb-3 break-words">
                    Resultados <span className="text-transparent bg-clip-text bg-gradient-to-r from-success to-emerald-400">Reales</span>
                </h1>
                <p className="text-text-muted text-sm sm:text-base max-w-2xl mx-auto mb-8 font-light">
                    ...
                    {[
                        ...
                        <div key={item.id} className="glass-card p-4 border border-white/10 relative overflow-hidden group hover:border-success/30 transition-all">
                            ...
                            <a 
                                ...
                                className="aspect-[4/3] bg-black/50 rounded-xl mb-4 relative overflow-hidden border border-white/5 flex items-center justify-center block cursor-zoom-in hover:border-success/50 transition-colors"
                            >
