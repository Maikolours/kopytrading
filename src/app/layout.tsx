                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-xs text-text-muted">
                      <li><Link href="/bots/cmn9hf8yc0000vhbcq9hbxk0j" className="hover:text-accent transition-colors">MAIKO PRO GOLD DEMO</Link></li>
                      <li><Link href="/bots/cmn9hf9440001vhbclffx9no6" className="hover:text-accent transition-colors">MAIKO PRO GOLD</Link></li>
                      <li><Link href="/bots/cmn9hf9800002vhbc5rky6dx8" className="hover:text-accent transition-colors">MAIKO PRO CENT</Link></li>
                      <li><Link href="/bots/cmpo1aurf0001vhdgp94zvl4m" className="hover:text-accent transition-colors">MAIKO YEN GHOST</Link></li>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-xs text-text-muted">
                      ...
                      <li><Link href="https://t.me/Kpytrading" target="_blank" className="hover:text-accent transition-colors">Únete al Canal de Telegram</Link></li>
