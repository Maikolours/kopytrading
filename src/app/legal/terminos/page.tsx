            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="glass-card border border-white/10 rounded-2xl p-8 space-y-8 text-text-muted text-sm leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>Al acceder a KopyTrading y adquirir cualquiera de nuestros productos digitales, aceptas en su totalidad los presentes Términos y Condiciones. Si no estás de acuerdo con alguno de ellos, te rogamos que no uses nuestros servicios.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-base mb-2">2. Naturaleza del Producto</h2>
                        <p>Los archivos vendidos en KopyTrading son software de algoritmos de trading en formato MQL5 (.mq5), diseñados para ejecutarse en la plataforma MetaTrader 5. Son <strong className="text-white">productos digitales de descarga inmediata</strong>. Una vez descargado el archivo, no existe posibilidad de devolución o reembolso al tratarse de un bien digital intangible.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-base mb-2">3. Licencia de Uso</h2>
                        <p>Al adquirir un bot de KopyTrading, se te concede una licencia de uso personal, intransferible y no exclusiva, limitada a:</p>
                    ...
                    <section>
                        ...
                        <p>KopyTrading no garantiza resultados financieros con el uso de sus productos. En ningún caso KopyTrading será responsable de pérdidas, daños o perjuicios económicos derivados del uso del software, incluyendo pero no limitándose a pérdidas de capital en operaciones de trading.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>KopyTrading se reserva el derecho de actualizar los bots adquiridos para mejorar su funcionamiento o adaptarlos a cambios en las plataformas de trading, sin cargo adicional para los compradores.</p>
                    </section>

                    <section>
                        <h2 className="text-white font-semibold text-base mb-2">7. Ley Aplicable y Jurisdicción</h2>
                        <p>Los presentes términos se rigen por la legislación española. Para cualquier controversia derivada del uso de KopyTrading, ambas partes se someten a los Juzgados y Tribunales correspondientes conforme a la normativa de comercio electrónico española.</p>
                    </section>
