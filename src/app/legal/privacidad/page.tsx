            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="glass-card border border-white/10 rounded-2xl p-8 space-y-8 text-text-muted text-sm leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>KOPYTRADE gestiona este sitio web. Para cualquier consulta relacionada con el tratamiento de tus datos personales, puedes contactarnos en: <a href="mailto:soporte@kopytrade.com" className="text-brand-light hover:underline">soporte@kopytrade.com</a></p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-2">Para ejercer tus derechos, escríbenos a: <a href="mailto:soporte@kopytrade.com" className="text-brand-light hover:underline">soporte@kopytrade.com</a></p>
                    </section>
