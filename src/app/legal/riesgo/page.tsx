    ...
    return (
        <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-brand-light text-sm mb-8">Léelo completo antes de usar cualquier bot de KOPYTRADING</p>
                ...
                <div className="glass-card border border-white/10 rounded-2xl p-8 space-y-8 text-text-muted text-sm leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>Al utilizar los bots de KOPYTRADING, el usuario reconoce y acepta que:</p>
                        <ul className="list-disc list-inside mt-2 space-y-1">
                            <li>Es el único responsable de la configuración, supervisión y uso del software</li>
                            <li>KOPYTRADING no tiene acceso a sus fondos, cuenta de broker ni datos de trading</li>
                            <li>KOPYTRADING no puede ser considerada responsable de pérdidas derivadas del uso del software</li>
                    ...
                    <section>
                        ...
                        <p>KOPYTRADING es una empresa de software. <strong className="text-white">No somos una empresa de inversión, gestión de activos, ni asesoramiento financiero regulado.</strong> Los bots que vendemos son herramientas de software, no señales de inversión ni recomendaciones financieras.</p>
                    </section>
                    ...
                    <div className="bg-danger/5 border border-danger/20 rounded-xl p-4 mt-4">
                        <p className="text-xs text-danger/80 font-medium">
                            Al descargar y usar cualquier bot de KOPYTRADING, confirmas haber leído, comprendido y aceptado íntegramente este Aviso de Riesgo, la Política de Privacidad y los Términos de Uso.
                        </p>
                    </div>
