...
export default function FloatingChat() {
    ...
    return (
        <>
            ...
            {/* Panel del chat */}
            {open && (
                <div className="fixed bottom-20 sm:bottom-24 left-4 right-4 sm:left-auto sm:right-6 z-[998] sm:w-[350px] h-[440px] max-h-[80vh] glass-card border border-brand/30 rounded-2xl shadow-[0_0_50px_rgba(139,92,246,0.3)] flex flex-col overflow-hidden">
                    {/* Header */}
