//+------------------------------------------------------------------+
//| XAU-MG_HUD_v3.4.mq5 - AMETRALLADORA (CORREGIDA)                  |
//| Versión con Fibonacci visible en HUD y en gráfico                |
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, Kopytrading Corp."
#property link      "https://www.kopytrading.com"
#property version   "3.41"
#property description "AMETRALLADORA v3.4 - Fibonacci visible"
...
void DrawFibonacciLevels() {
   ...
   // Zona OTE (rectángulo semitransparente)
...
//+------------------------------------------------------------------+
//| HUD COMPLETO CON FIBONACCI VISIBLE                               |
//+------------------------------------------------------------------+
void CrearHUD() {
   ObjectsDeleteAll(0, PNL_TAG);
   int x = 10, y = 10, w = 580, h = 820;
   ...
   // FIBONACCI (NUEVA SECCIÓN VISIBLE)
