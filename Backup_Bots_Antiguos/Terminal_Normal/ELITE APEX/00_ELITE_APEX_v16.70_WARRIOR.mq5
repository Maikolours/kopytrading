...
void CrearPanel() {
   ...
   int br=18, bg=10, bb=10; color cbg = StringToColor(StringFormat("%d,%d,%d",br,bg,bb));
   CrRect("bg", x, y, w, h, clrBlack, clrMaroon, 2); 
   CrRect("hdr", x+2, y+2, w-4, 40, clrMaroon, clrRed);
   CrLabel("ttl", x+15, y+8, "ELITE APEX v16.70 WARRIOR", clrWhite, 10);
