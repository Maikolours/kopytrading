...
void CrearPanel() {
   ...
   CrRect("bg", x, y, w, h, C'18,10,10', C'220,40,40', 2); CrRect("hdr", x+2, y+2, w-4, 40, C'45,15,15', C'70,20,20');
   CrLabel("ttl", x+15, y+8, "ELITE APEX v16.65 WARRIOR", clrWhite, 10);
   CrLabel("clk", x+w-120, y+8, "[00:00]", clrGold, 10);
   CrBtn("b_min", x+w-35, y+2, 25, 25, isMinimized ? "▢" : "_", clrDarkRed, clrWhite);
   if(!isMinimized) {
      CrRect("pl_bg", x+10, y+75, w-20, 105, C'30,10,10', C'120,30,30'); CrLabel("pl_t", x+20, y+80, "🎯 ESTRATEGIA WARRIOR PREDATOR:", clrOrangeRed, 7);
      ...
      CrRect("ote_bg", x+10, y+230, w-20, 105, C'20,20,20', C'80,80,20'); CrLabel("ote_t", x+20, y+235, "🏹 GESTIÓN SNIPER ACTIVADA:", clrGold, 7);
