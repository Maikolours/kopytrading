...
int SyncIntervalSec = 2;         // Enviar datos cada 2 segundos
...
input double MaxRsiCompra = 70.0; // Evitar comprar por encima de 70 (sobrecompra)
input double MinRsiVenta = 30.0;  // Evitar vender por debajo de 30 (sobreventa)
