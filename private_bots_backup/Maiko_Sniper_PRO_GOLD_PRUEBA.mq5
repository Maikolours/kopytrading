...
input string TradeComment = "MAIKO_GOLD_PRUEBA";

// Globales
CTrade trade;
input int ExpertMagic = 888777; // Identificador Unico (Magic Number)
...
void CrearInterfazMaster() { 
    ...
    CrearLabel("MAIKO_T", x+10, y+10, "MAIKO PRO | GOLD PRUEBA v13.92", ColorMain, 11, 10001); 
