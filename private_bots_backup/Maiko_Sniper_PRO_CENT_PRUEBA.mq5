...
input string TradeComment = "MAIKO_CENT_PRUEBA";

// Globales
CTrade trade;
input int ExpertMagic = 888666; // Identificador Unico (Magic Number)
...
void CrearInterfazMaster() { 
    ...
    CrearLabel("MAIKO_T", x+10, y+10, "MAIKO PRO | CENT PRUEBA v13.92", ColorMain, 11, 10001); 
