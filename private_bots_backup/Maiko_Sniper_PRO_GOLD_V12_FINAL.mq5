...
// --- GESTION DE LOTAJE ---
input double LotajeInicial = 0.02; // Lote Inicial
input double MultiplicadorRefuerzo = 1.0; 
input double MaxLoteIndividual = 0.03; // Lote fijo por SOS
...
// --- OBJETIVOS DE PROFIT ---
input double ProfitCosechaCents = 10.0; // Ganancia en Dolares (Operacion Individual)
input double ProfitNetoCents = 10.0; // Ganancia en Dolares (Operacion Colectiva SOS)
...
// Globales
CTrade trade;
input int ExpertMagic = 111222; // Magic Number (111222 para V11, 888777 para PRUEBA)
...
bool BotActivo = true; // EMPEZAR ENCENDIDO
...
void CrearInterfazMaster() { 
    ...
    CrearLabel("MAIKO_T", x+10, y+10, "MAIKO PRO | GOLD V12_PRO", ColorMain, 11, 10001); 
