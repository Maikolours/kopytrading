...
input double   MaxLoteTotal               = 1.00;        // 🚫 Lote Máximo Acumulado Permitido
input double   MaxLoteIndividual          = 0.20;        // 🚫 Lote Máximo por Operación SOS
...
input double   ProfitCosechaIndividual    = 0.10;        // 💵 Beneficio Cierre SOS Individual ($)
...
input double   ProfitBreakEven            = 0.05;        // 🛡️ Beneficio Mínimo Break Even Cesta ($)
