...
// 2. Desbloquear licencia para cuenta CENT cuando lic esté vacía (evitar alerta F7)
...
const licBypass = `if(lic == "") {
            // Licencia habilitada para cuenta CENT del usuario
            BotActivo = true;
            trialExpirado = false;
        }`;
...
if (fs.existsSync(editorPath)) {
    try {
        ...
        console.log("✓ Compilación limpia exitosa.");
    } catch(e) {
...
if (fs.existsSync(basePath)) {
    ...
    console.log("✓ Desplegado MAIKO_PRO_GOLD_CENT 100% perfecto en todos los terminales MT5.");
}
