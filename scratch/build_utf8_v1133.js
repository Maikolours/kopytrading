...
// Read as utf16le (properly decodes the characters)
...
// We must remove the \uFEFF BOM if it exists because when we write as utf8, it will be added as a character
code = code.replace(/^\uFEFF/, '');

// Write to files as UTF8
...
try {
    ...
    console.log("✓ Compilado V11.33 UTF8 sin errores!");
} catch(e) {
