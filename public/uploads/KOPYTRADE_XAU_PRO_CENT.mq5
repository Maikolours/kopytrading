...
input int      EntradaPoints       = 1000;     // 📥 Distancia de entrada (GATES) en puntos.
input int      DistanciaRefuerzo   = 500;      // 📥 Distancia para orden de REFUERZO.
input int      DistanciaRescatePoints = 400;   // 📥 Distancia para orden de RESCATE.
