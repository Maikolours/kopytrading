//|          BTCSTORM_RIDER_ULTRA_v7.10 - EDICIÓN "AUTO-CHARTS"        |
...
input bool     EsCuentaCent      = true;       // 💰 Activar si es cuenta CENT
...
input double   MetaDiaria_USD      = 2000.0;    // 🎯 Ganancia Diaria (2000 unid. = $20).
input double   Meta_Ciclo_USD      = 500.0;     // Neto para cerrar ciclo (500 unid.)
input double   Harvest_TP_USD      = 200.0;     // TP individual (200 unid.)
...
double         mode_HarvestTP = 200.0;
double         mode_CycleMeta = 500.0;
double         mode_BETrigger = 200.0;
int            mode_MaxPos    = 4;
double         mode_DistUSD   = 3.0; // Más distancia para Cent
...
int OnInit() {
   ...
   ChartIndicatorAdd(0, 0, maHandle);   // Media al gráfico principal
   ChartIndicatorAdd(0, 1, rsiHandle);  // RSI a subventana 1
...
void CrearPanel() {
   ...
   CrLabel("ttl", x+15, y+8, "BTC STORM RIDER v7.1", clrWhite, 11, "Arial Bold");
