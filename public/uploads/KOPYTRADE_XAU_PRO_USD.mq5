...
input double   MetaDiaria_USD      = 20.0;      // 🎯 Ganancia Diaria (20 USD).
input double   Meta_Ciclo_USD      = 5.0;       // Neto para cerrar ciclo (5 USD)
input double   Harvest_TP_USD      = 2.0;       // TP individual (2 USD)
...
input int      EntradaPoints       = 800;      // 📥 Distancia de entrada (GATES) en puntos (800 = $8).
input int      DistanciaRefuerzo   = 400;      // 📥 Distancia para orden de REFUERZO (4 pips).
input int      DistanciaRescatePoints = 300;   // 📥 Distancia para orden de RESCATE (3 pips).
