...
input double ProfitScalpIndividual = 20.0; // Profit individual para posiciones SOS (cents)
...
int hEMA_H4, hEMA_H1, hEMA_M15, hEMA_M5, hEMA_M1, hRSI, hMACD, hATR, hADX, hADX_Chart;
int hRadar[7];
...
int OnInit() {
    ...
    ChartIndicatorAdd(0, 0, hEMA_M1); // EMA visible en el gráfico principal
...
void OnTick() {
    ...
    if(ArraySize(pos) > 0) { 
        ...
        if(!emaOK) txtVeredicto = "ESPERANDO CRUCE EMA (M5/M1)...";
