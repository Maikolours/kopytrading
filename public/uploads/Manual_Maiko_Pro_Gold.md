...
## 3. CONSEJOS Y LÍMITES (VERSIÓN DEMO Y CLIENTES)
...
- **Límites de Configuración:** Por seguridad de la estrategia, las opciones avanzadas están encriptadas. Solo podrás configurar el **Lotaje Sniper Base** y el **Máximo de Re-entradas** (limitado a 3 como máximo para proteger la cuenta).
