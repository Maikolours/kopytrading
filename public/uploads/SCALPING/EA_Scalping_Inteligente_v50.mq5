//+------------------------------------------------------------------+
//| EA Scalping Inteligente v5.0 – MT5 (CON FILTRO DE HORARIO)       |
//| Evita noticias macroeconómicas operando sólo en los tramos       |
//+------------------------------------------------------------------+
#property strict
...
void DrawPanel()
{
   ...
   string text = "╔══════════════════════════════════════════════╗\n";
   text += "║  EA Scalping v5.0 [Horario de Noticias] \n";
   text += "╠══════════════════════════════════════════════╣\n";
...
void OnTick()
{
   ...
   if(!IsTradingTime()) return; // <--- Si no es hora de operar, bloqueamos las nuevas entradas
