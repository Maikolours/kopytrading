//+------------------------------------------------------------------+
//|     KOPYTRADE_BTCUSD_EVOLUTION_v7_5 - BTC AMETRALLADORA RÍTMICA  |
...
#property strict
#property description "BTC RHYTHM 1-1-2-2 | $5.00 Cycle Target | Agile Recovery"
...
string         botStatus = "LISTO", commentTag = "EVO_BTC_75";
...
int OnInit() {
   ...
   dynGatilloHedge = GatilloHSP_USD;
   ...
   for(int i=PositionsTotal()-1; i>=0; i--) {
      if(posInfo.SelectByIndex(i) && posInfo.Magic()==activeMagic) {
         ...
         if(ActivarBE && pUSD >= BE_Trigger_USD) {
            ...
            double dist = (_Symbol=="BTCUSD") ? 1000 : 10;
            double be = (posInfo.PositionType()==POSITION_TYPE_BUY) ? posInfo.PriceOpen()+dist*_Point : posInfo.PriceOpen()-dist*_Point;
...
void CrearHUD() {
   ...
   CrLabel("ttl",x+15,y+10,"BTC EVO v7.5 RÍTMICA",clrWhite,10,"Arial Bold");
